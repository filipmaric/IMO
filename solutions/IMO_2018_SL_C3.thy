...
subsection \<open>Labeled move max stone\<close>
...
subsection \<open>Valid labeled game move max stone length\<close>
...
subsection \<open>Valid game length\<close>
